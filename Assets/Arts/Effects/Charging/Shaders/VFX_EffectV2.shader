Shader "VFX/VFX_EffectV2"
{
    ...
    //-----------------------------------------------------------------------------
        ...
        [Header(SoftParticle)]  
         [Toggle(_USESOFTPARTICLE)]_USESOFTPARTICLE("UseSoftParticle", Float) = 0
        _SoftLength("SoftLength", Range(0.01, 10)) = 0.01
        ...
        SubShader
        {
            ...
            #pragma shader_feature _USEPARTICLECUSTOMDATA
             ...
             #pragma shader_feature _USESOFTPARTICLE
            ...
            float4 frag(v2f i) : SV_Target
            {
                ...
                // 计算粒子与场景的深度差
                float partZ =  i.viewZ;;
                float fade = saturate((sceneZ - partZ) / _SoftLength );
                // 根据深度差调整粒子透明度
                col.a *= fade;
#endif
